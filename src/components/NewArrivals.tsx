...
const NewArrivals = () => {
  return (
    <section className='px-5 md:px-20 py-10 h-fit flex flex-col-reverse md:flex-row-reverse md:min-h-screen justify-center items-center gap-10' style={{ background: '#FFF9E5' }}>
