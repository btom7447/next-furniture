      ...
      <div className="pointer-events-auto flex flex-col justify-between items-start">
        ...
        <nav className="w-full py-5 px-5 md:px-10 flex justify-between items-center md:gap-10 border-t-1 border-gray-300">
            <Link
              ...
              className="relative py-3 px-3 md:px-10 text-xl rounded-4xl bg-white border-1 border-gray-700 text-black hover:text-white hover:bg-gray-900 transition-colors duration-300"
            >
              View Cart
            </Link>
            <Link
