...
const TopPicks = async () => {
    ...
    return (
        <div className='p-10 md:p-20 flex flex-col justify-center items-center w-full bg-white'>
            ...
            <p className='text-xl text-gray-500 text-center mt-4'>Find a bright ideal to suit your taste with our great suspension, floor and table lights.</p>
            <TopPickCarousel products={products} />
            <Link href="/shop" className='block mt-10 text-2xl'>
                <button type="button" className='border-b border-black py-2 cursor-pointer'>
                    View More
                </button>
            </Link>
        </div>
